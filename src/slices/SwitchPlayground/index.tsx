  ...
  return (
    ...
    >
      <FadeIn>
        ...
        <div className="max-4xl mb-6 text-xl text-pretty">
          <PrismicRichText field={slice.primary.description} />
        </div>

        <FadeIn
          targetChildren
          className="grids-cols-1 grid gap-4 overflow-hidden sm:grid-cols-2"
        >
...
const SharedCanvas = ({ color }: SharedCanvasProps) => {
  ...
  const colorName = color.uid as "red" | "blue" | "brown" | "black";
  ...
  return (
    <div className="group relative min-h-96 overflow-hidden rounded-3xl select-none">
      ...
      {/* {canvas} */}
      <Canvas camera={{ position: [1.5, 2.0, 0], fov: 7 }}>
        <Stage
          adjustCamera
          intensity={0.5}
          shadows={"contact"}
