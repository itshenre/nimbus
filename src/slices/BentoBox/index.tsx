...
const BentoBox: FC<BentoBoxProps> = ({ slice }) => {
  return (
    ...
    >
      <FadeIn>
        <h2 id="features" className="font-bold-slanted text-6l mb-8 scroll-pt-6 uppercase md:text-8xl">
...
function BentoBoxItem({ item }: BentoBoxItemProps) {
  return (
    ...
    >
      ...
      <div className="from absolute inset-x-0 bottom-0 h-1/3 bg-gradient-to-b from-transparent to-black"></div>
